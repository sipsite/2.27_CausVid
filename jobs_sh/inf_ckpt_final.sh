...
#SBATCH --output=job_log/log_inf3_%j.out
...
python minimal_inference/autoregressive_inference.py \
  ...
  --checkpoint_folder /scratch/peilab/ysunem/26.2/2.27_CausVid/data/model_ckpt/autoregressive_checkpoint \
  --output_folder jobs_sh/inference_output_final \
